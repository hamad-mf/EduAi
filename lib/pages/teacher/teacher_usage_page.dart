...
import 'teacher_api_settings_page.dart';

class TeacherUsagePage extends StatefulWidget {
  const TeacherUsagePage({super.key, required this.teacher});

  final AppUser teacher;

  @override
  State<TeacherUsagePage> createState() => _TeacherUsagePageState();
}

class _TeacherUsagePageState extends State<TeacherUsagePage> {
  int _studentCount = 0;
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute<void>(
                  builder: (_) => const TeacherApiSettingsPage(),
                ),
              );
            },
            child: Container(
